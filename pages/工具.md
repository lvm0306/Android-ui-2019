...
|[RxRedux](https://github.com/freeletics/RxRedux)|使用RxJava 2 管理状态的library。|
...
# Json & Xml
|[fastjson](https://github.com/alibaba/fastjson)|阿里巴巴的json框架||
...
|[stag-java](https://github.com/vimeo/stag-java)|Stag通过为能||
...
|[RxBasicsKata](https://github.com/sergiiz/RxBasicsKata)|学习使用JUnit测试作为接受标准的RxJava的一组简单代码挑战|
...
|[SwissArmyKnife](https://github.com/android-notes/SwissArmyKnife)|android免root兼容所有版本ui调试工
|[JakeWharton/hugo](https://github.com/JakeWharton/hugo)|您的调试版本的注释触发方法调用日志记录。||
|[debugkit](https://github.com/hulab/debugkit)|曾经在你的用户界面中隐藏调试功能？这里现在是一个干净的方式来做到这一点！||
...
# 拼音
|[UniPinyin](https://github.com/nillith/UniPinyin)|Java 汉语拼音查询工具||
...
|[MaterialColdStart](https://github.com/DreaminginCodeZH/MaterialColdStart)|冷启动||
...
|[user-validator](https://github.com/ShootrNetwork/user-validator)|验证用户名、电子邮件和密码的库||
...
|[MeiqiaSDK-Android](https://github.com/Meiqia/MeiqiaSDK-Android)|美洽 Android SDK 3.0 面向开发者的 Demo|| 
...
|[AppUpdater](https://github.com/javiersantos/AppUpdater)|在Google Play，GitHub，亚马逊，F-Droid或您自己的服务器上检查应用程序更新的库。 |
...
|[lib_download](https://github.com/wangdanlizhiyun/lib_download)|处理异步下载的库|||[Aria]( https://github.com/AriaLyy/Aria)|文件下载管理||
|[android-lite-go](https://github.com/litesuits/android-lite-go)|LiteGo是一款基于Java语言的「异步并发类库」||
|[EasyThread](https://github.com/yjfnypeu/EasyThread)|一款安全、轻巧、简单的线程池管理器|
...
|[AndroidAsync](https://github.com/koush/AndroidAsync)|用于android的异步套接字||
...
|[AndroidKeyboardWatcher]( https://github.com/AzimoLabs/AndroidKeyboardWatcher)|Android 软键盘工具库||
...
# SharePreference
|[Treasure]( https://github.com/baoyongzhang/Treasure)|SharePrefence 工具||
|[Favor](https://github.com/soarcn/Favor)|简单实用SharePrefence||
...
|[esperandro](https://github.com/dkunzler/esperandro)|Easy SharedPreference||
|[AnyPref](https://github.com/NashLegend/AnyPref)|SharedPreferences中的ORM||
|[Prefs](https://github.com/GrenderG/Prefs)| SharedPreferences wrapper||
...
|[Recovery]( https://github.com/Sunzxyong/Recovery)|一个App异常恢复框架||
|[FireCrasher](https://github.com/osama-raddad/FireCrasher)|FireCrasher是一个未捕获的android异常恢复库||
|[CustomActivityOnCrash]( https://github.com/Ereza/CustomActivityOnCrash)|崩溃检测并且弹窗||
...
|[AutoCrashReporter]( https://github.com/devsideal/AutoCrashReporter)ACR是一个Android库，可以在您的应用程序正在开发时简化崩溃检测||
...
|[maoni-email](https://github.com/rm3l/maoni-email)|Android 收集用户基本信息利器||



# 热修复，插件化
|[VasSonic](https://github.com/Tencent/VasSonic)|VasSonic:轻量级高性能Hybrid框架||
|[Robust](https://github.com/Meituan-Dianping/Robust)|美团的新一代热更新系统Robust，对Android版本无差别兼容||
|[tinker]( https://github.com/Tencent/tinker)|Tinker是一个针对Android的热修复解决方案库，它支持dex、库和资源更新，无需重新安装apk。||
|[Amigo](https://github.com/eleme/Amigo)|一个Android 平台的hotfix 库, 支持热更新，支持热修复||
|[restito](https://github.com/mkotsur/restito)|Restito - 用于测试rest客户机的mock框架||
|[VirtualAPK](https://github.com/didi/VirtualAPK)|滴滴插件化工具适用于Android的功能强大且轻量级的插件框架||
...
|[ActivityRouter]( https://github.com/mzule/ActivityRouter)|Router||
...
|[BakeBread：https](https://github.com/bitstadium/BakeBread)|允许事后调试Android NDK应用程序和库(检查堆栈帧和变量值)||
|[LoveUT](https://github.com/geniusmart/LoveUT)|测试工具Robolectric 3.x 的介绍和实战||
|[Kubwa：https](https://github.com/WesleyElliott/Kubwa)|基于注释的验证库，用于MVVM体系结构中的Android的DataBinding库||
|[VirtualApp](https://github.com/asLody/VirtualApp)|App 虚拟空间，类似 LBE 双开空间||
|[weex](https://github.com/apache/incubator-weex)|跨平台开发 alibaba||
...
|[test-butler](https://github.com/linkedin/test-butler)|可靠的Android测试||
|[HtmlNative](https://github.com/hsllany/HtmlNative)|使用Html来渲染Android界面的动态化界面方案。||
|[python-for-android](https://github.com/kivy/python-for-android)|用 Python 开发 Android 应用程序||
|[Magisk](https://github.com/topjohnwu/Magisk)|一个神奇的面具，以改变Android系统||
...
|[AndroidDevMetrics]( https://github.com/frogermcs/AndroidDevMetrics)|P适用于Android开发的性能指标库||
|[MAHAds](https://github.com/hummatli/MAHAds)|广告跳转||
|[debugkit](https://github.com/hulab/debugkit)|Android 浮动 Debug 工具箱||
...
|[Bugtags-Android]( https://github.com/bugtags/Bugtags-Android)|为移动测试而生，随时随地改善你的移动应用|
|[redex](https://github.com/facebook/redex)|facebook 出品的 apk 包优化工具 ||
|[enjarify](https://github.com/google/enjarify)|Enjarify是一个工具，用于将Dalvik字节码转换为等价的Java字节码||
|[legend](https://github.com/asLody/legend)|hook java方法的框架，针对6.0以下得系统||
|[easydeviceinfo]( https://github.com/nisrulz/easydeviceinfo)|Android库以超级简单的方式获取设备信息||
...
|[gradle](https://github.com/gradle/gradle)|For more information about Gradle||
|[UETool](https://github.com/eleme/UETool)|UETool 它可以作用于任何显示在屏幕上的 view||
...
|[AndroidGodEye](https://github.com/Kyson/AndroidGodEye)|适用于Android的性能监视器工具|
...
|[AndroidToolsExample](https://github.com/xiaweizi/AndroidToolsExample)|Android 中 tools 命名的使用案例||
...
|[debug_view_kotlin](https://github.com/heimashi/debug_view_kotlin)|debug_view_kotlin||
...
|[idea-gradle-dependencies-formatter](https://github.com/platan/idea-gradle-dependencies-formatter)|IntelliJ IDEA的Gradle依赖性格式化程序||
...
|[Cicerone](https://github.com/terrakok/Cicerone)|Cicerone是一个轻量级的库，使得Android应用程序中的导航变得简单|
...
|[vertical-stepper-form](https://github.com/ernestoyaquello/vertical-stepper-form)|适用于Android的垂直步进式表格库||
|[MaterialDesignSamples](https://github.com/pinguo-zhouwei/MaterialDesignSamples)|Material Design 系列控件samples|| 
|[CompositeAndroid](https://github.com/passsy/CompositeAndroid)|Android组件(比如Activity或Fragment)的组合优于继承||
...
|[name that color](https://github.com/galex/name-that-color-intellij-plugin)|这个插件可以让你为你复制的颜色插入一个名称|
...
|[ThinkAndroid](https://github.com/white-cat/ThinkAndroid)|ThinkAndroid是一个免费的开源的Android开发框架|
...
|[Rosie]( https://github.com/Karumi/Rosie)|Rosie是一个Android框架，用于按照Clean Architecture的原则创建应用程序||
|[KBinding](https://github.com/BennyWang/KBinding)|使用kotlin实现的Android MVVM框架，基于anko，比databinding更简单易用|| 
|[mvvm-starter](https://github.com/flipboxstudio/mvvm-starter)|使用DataBinding Library启动Android MVVM项目||
|[RainbowMVP](https://github.com/Ne1c/RainbowMVP)|轻量级Android MVP库，易于实现||
|[ThirtyInch](https://github.com/grandcentrix/ThirtyInch)|Android 一个MVP库||
|[MVP-RX-Android-Sample]( https://github.com/ahmedeltaher/MVP-RX-Android-Sample)MVP Kotlin 开发框架|| 
|[ferro]( https://github.com/MaksTuev/ferro)|简单而强大的MVP库为Android||
|[BGAScaffolding-Android](https://github.com/bingoogolapple/BGAScaffolding-Android)|Android MVC、MVP、MVVM 项目开发脚手架||
|[android-mvp-architecture](https://github.com/MindorksOpenSource/android-mvp-architecture)|MVP开发框架||
...
|[android-clean-architecture-boilerplate](https://github.com/bufferapp/android-clean-architecture-boilerplate)|一个使用干净架构的android样板工程||
|[AndFrameWorks](https://github.com/scwang90/AndFrameWorks)|AndFrame 是一个能够让你快速进行Android开发的开源框架||
...
|[LessCode](https://github.com/openproject/LessCode)|打造精简、高效的最好Android工具库！||
...
|[UReflection](https://github.com/mnayef95/UReflection)|一个轻量级的android库，可以快速集成到任何应用程序使用android utils||
|[android-utils](https://github.com/nisrulz/android-utils)|由实用程序脚本/类/包组成的存储库||
